            ...
            <div class="row">
                <div class="col-md-12 center">
                    ...
                    <a class="brand pull-left" href="">
                        <img src='<c:url value="/resources/img/logo_re.png"></c:url>' alt="LifeSaver">
        ...
        <div class="container">
            ...
            <header class="emergency__header">
                ...
                <div class="title__mark">
                    <img src='<c:url value="/resources/img/pageLine.png"></c:url>' alt="">
                ...
                <div class="info__box01" id="up__line">
                    <a href="#"><img src='<c:url value="/resources/img/cpr.png"></c:url>'alt=""></a>
                    
                    <a href="#"><img src='<c:url value="/resources/img/agument.png"></c:url>' alt=""></a>
                    
                </div>

                <div class="info__box02">
                    <a href="#"><img src='<c:url value="/resources/img/kgInfo.png"></c:url>' alt=""></a>
                    
                    <a href="#"><img src='<c:url value="/resources/img/license.png"></c:url>' alt=""></a>
               ...
               var show_dist = Math.round(dist);
                ...
                drawCircleRange(mouseLatLng, 100);
                  ...
                  mpPositions = [myPlace];
                   ...
                   latitude= position.coords.latitude;   longitude=position.coords.longitude;
                  Hours=Now.getHours(); Minutes=Now.getMinutes(); Seconds=Now.getSeconds();
                       window.open("/lifesaver/mapOk.jsp?latitude="+latitude+"&longitude="+longitude+"&Hours="+Hours+"&Minutes="+Minutes
                           +"&Seconds="+Seconds + "&ssb_situation_num=", "newWindow", "width=300, height=400, scrollbar=no");
                  }else{
                     alert("세이버 매치가 불가합니다.");
                     }
