$(document).ready(function() {
    ...
    $('#page-welcome .logo a').click(function() {
        $('html, body').animate({
            scrollTop: $($.attr(this, 'href')).offset().top - navigationHeight - 200
        }, 800);
    ...
    $(document).on('click', '#status-move', function(event) {
        var headerHeight = $('#main-menu').outerHeight();
        event.preventDefault();
        $("html,body").animate({
            scrollTop: $(this.hash).offset().top - headerHeight + 100
        }, 300)
    });
    $(document).on('click', '#grade-move', function(event) {
        var headerHeight = $('#main-menu').outerHeight();
        event.preventDefault();
        $("html,body").animate({
            scrollTop: $(this.hash).offset().top - headerHeight - 200
        }, 300)
    });
    $(document).on('click', '#feature-move', function(event) {
        var headerHeight = $('#main-menu').outerHeight();
        event.preventDefault();
        $("html,body").animate({
            scrollTop: $(this.hash).offset().top - headerHeight - 60
        }, 300)
    });
    $(document).on('click', '#about-move', function(event) {
        var headerHeight = $('#main-menu').outerHeight();
        event.preventDefault();
        $("html,body").animate({
            scrollTop: $(this.hash).offset().top - headerHeight - 70
        }, 300)
    });
    $(document).on('click', '#blog-move', function(event) {
        var headerHeight = $('#main-menu').outerHeight();
        event.preventDefault();
        $("html,body").animate({
            scrollTop: $(this.hash).offset().top - headerHeight - 250
        }, 300)
    });
    $(document).on('click', '#contact-move', function(event) {
        var headerHeight = $('#main-menu').outerHeight();
        event.preventDefault();
        $("html,body").animate({
            scrollTop: $(this.hash).offset().top - headerHeight + 100
