package kr.co.lifesaver.support.service;
...
public class SupportVO {
	...
	private int price; // �Ŀ���
	private String box; 	// �Ŀ� ���
	private String box2; // �Ŀ� ���
...
// --------------------------------------------------------------------------------
	...
	public SupportVO(String cr_name, String cr_number, String cr_man_name, String cr_man_phone_number, int price,
			String box, String box2) {
		super();
