...
<link rel="stylesheet" type="text/css" href="../css/saverjoin.css">
...
<form action="./saverjoinOK" method="post" name="frm">

	<div id="container">

		<div id="header">
			<img src="img/saverjoin/logo.png" alt="로고" id="logo" /> <br /> 
			<span id="step">Step.1 약관동의&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				Step.2 회원정보입력&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				Step.3 가입완료</span> <br /> <img src="img/saverjoin/actionLine.png" alt="" />
		</div>
		...
		<div id="frame">
			...
			<div id="auth">
			<a href="https://kauth.kakao.com/oauth/authorize?client_id=5461997da2e1069ba99ac732d8c5018c&redirect_uri=http://localhost:9090/kakaoLogin/registerAuth&response_type=code&scope=account_email">
				<img src="img/saverjoin/kakaoBtn.png" alt="" /> 
			</a>
				<img src="img/saverjoin/googleBtn.png" alt="" />
			</div>
			...
			<div id="insert">
				...
				<div id="pwcheckfield" class="fields">
					...
					<div id="pwcheck_text" class="texts">
						<input type="text" name="" id="pwcheck" />
					</div>
				</div>
